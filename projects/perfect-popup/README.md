...
After building your library with `ng build perfect-popup`, go to the dist folder `cd dist/perfect-popup` and run `npm publish`.

## Running unit tests

Run `ng test perfect-popup` to execute the unit tests via [Karma](https://karma-runner.github.io).
